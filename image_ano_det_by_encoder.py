...
def check_anomaly(img_path):
    ...
    reconstruction_error_threshold = 0.05 # Set this value based on the above exercise
...
import glob
para_file_paths = glob.glob('Data/parasitized/Class1/*')
uninfected_file_paths = glob.glob('Data/uninfected_train/Class1/*')
...
#Anomaly image verification
check_anomaly(para_file_paths[22])

#Good/normal image verification
check_anomaly(uninfected_file_paths[9])